...
function buildNav(members) {
  ...
  members.api = find({ kind: 'function' }).filter(function(fnDoclet) {
  ...
  nav += buildMemberNav(members.rpc, 'ACT', seenRpc, linkto);
  nav += buildMemberNav(members.namespaces, 'Services', seen, linkto);
  nav += buildMemberNav(members.interfaces, 'Interfaces', seen, linkto);
  nav += buildMemberNav(members.events, 'Events', seen, linkto);
  nav += buildMemberNav(members.modules, 'Modules', {}, linkto);
  nav += buildMemberNav(members.classes, 'Plugins', seen, linkto);
  nav += buildMemberNav(members.externals, 'Externals', seen, linktoExternal);
  nav += buildMemberNav(members.mixins, 'Utility', seen, linkto);
